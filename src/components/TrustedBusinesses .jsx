...
const TrustedBusinesses = () => {
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-white py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 items-center justify-center bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-6 md:p-10 lg:p-12">
                    <div className="flex-1  text-black rounded-xl p-10 md:p-12 relative overflow-hidden min-h-[22rem] md:min-h-[26rem] flex flex-col justify-between">
                        <i className="fas fa-quote-right text-black text-7xl md:text-8xl opacity-10 absolute top-6 right-6 animate-pulse"></i>
                        <p className="text-xl md:text-2xl font-semibold leading-relaxed relative z-10">
